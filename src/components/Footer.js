...
<p className='text-[15px] my-1'>All rights reserved.</p>
       ...
       <ul className='flex flex-col lg:flex-row my-14 mx-10'>
           <li> 
               <Link to="/" className='my-2 mx-2'>Home</Link>

           </li>
           <li> 
               <Link to="about" className='my-2 mx-2'>About Us</Link>

           </li>
           <li> 
               <Link to="working" className='my-2 mx-2'>How it works</Link>

           </li>
           <li> 
               <Link to="contact" className='my-2 mx-2'>Contact</Link>

           </li>
         
           <li> 
               <Link to="help" className='my-2 mx-2'>Help</Link>
       ...
       <ul className='flex my-4 mx-10 lg:mr-32'>
           <li><img src={FacebookSvg} alt="" className='mx-3 lg:mx-7' /></li>
           <li><img src={InstagramSvg} alt="" className='mx-3 lg:mx-7' /></li>
           <li><img src={TwitterSvg} alt="" className='mx-3  lg:mx-7'/></li>
           <li></li>
       </ul>
