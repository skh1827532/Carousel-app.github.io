...
export default function SecondComponent() {
  return (
    <>
        ...
        <div className=" top-0 left-0 anotherCont gap-[1rem] my-8  flex flex-col lg:flex-row bg-white rounded-[12px] w-[80%] mx-auto border-r-[15px] border-b-[15px]  borderColor ">
